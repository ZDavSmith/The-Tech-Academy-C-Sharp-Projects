...
namespace StudentManagementSystem.Controllers
{
    ...
    {
        private string _connectionString = @"Data Source=MSI-ZACH\SQLEXPRESS;Initial Catalog=School;Integrated Security=True;Connect Timeout=30;
        ...
        public ActionResult Index()
        {
            ...
            return View(students);//The parameter is how it decyphers which list
        }
